...
install_xcframework "${PODS_ROOT}/GoogleUserMessagingPlatform/Frameworks/Release/UserMessagingPlatform.xcframework" "UserMessagingPlatform" "framework" "ios-arm64_armv7/UserMessagingPlatform.framework" "ios-arm64_i386_x86_64-simulator/UserMessagingPlatform.framework"
